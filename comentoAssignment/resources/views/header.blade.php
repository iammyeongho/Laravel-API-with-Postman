    ...
    <div class="wrapper">
        <header>
            ...
            <div class="hd-top-right">
                <div class="hd-top-right-l hd-top-right-l-on">
                    <a>이야기 하기</a>
                </div>
                <div class="hd-top-right-c">
                    <a>대장 고양이 되기</a>
                </div>
                <div class="hd-top-right-r">
                    <a>로그인 하기</a>
                </div>
            </div>
        </header>
        ...
        <main>
            <div class="board-mi-cover">
                <div class="board-mi-top-title">
                    <h2>묻고 답해요</h2>
                </div>
                <div class="board-mi-button-cover">
                    <div class="board-mi-button-r">
                        <a href="">질문하기</a>
                    </div>
                    <div class="board-mi-button-l-cover">
                        <form class="board-search-form">
                            <input type="search" value="" placeholder="Search" class="board-search-input">
                            <button type="submit" class="board-search-button">
                                <svg class="board-submit-button">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#search"></use>
                                </svg>
                            </button>
                            <div class="board-search-option">
                                <div>
                                <input name="type" type="radio" value="type-users" id="type-users">
                                <label for="type-users">
                                    <svg class="board-edit-pen-title">
                ...
                <div class="board-mi-question-cover">
                    <div class="board-mi-question-items">
                        <div class="board-mi-question-items-top">
                            <div class="board-mi-question-items-top-tag">
                                <p class="board-mi-question-items-top-cat">집사고민</p>
                                <p class="board-mi-question-items-top-cat">먼치킨</p>
                            </div>
                            <p class="board-mi-question-items-top-date">2024-01-31</p>
                        </div>
                        <div class="board-mi-question-items-title-cover">
                            <p class="board-mi-question-items-title">이럴 때는 어떻게 해야할까요?</p>
                        </div>
                        <div class="board-mi-question-items-contents-cover">
                            <p class="board-mi-question-items-contents">이렇게하면 되나요?</p>
                        </div>
                        <div class="board-mi-question-items-bottom">
                            <p>답변수 : 30</p>
                            <p>조회수 : 20</p>
                        </div>
                    </div>
                ...
                <div class="board-mi-question-pagination">
                    <p><</p>
                    <p>1</p>
                    <p>2</p>
                    <p>3</p>
